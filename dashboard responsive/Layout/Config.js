...
import { IconAlignBoxRightTop } from "@tabler/icons";
...
const AppConfig = (props) => {
    ...
    return (
        <>
            ...
            <Button className="layout-config-button" color="red" radius="xl" onClick={onConfigButtonClick}>
                <IconAlignBoxRightTop size={100} />
            </Button>
