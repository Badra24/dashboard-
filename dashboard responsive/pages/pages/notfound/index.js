...
import AppConfig from "../../../Layout/Config";
...
const NotFoundPage = () => {
    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden bg white">
            <div className="flex flex-column align-items-center justify-content-center">
                <img src={`${contextPath}/demo/images/notfound/404.gif`} alt="Sakai logo" className="mb-5 w-20rem flex-shrink-0" />
                <div style={{ borderRadius: "56px", padding: "0.3rem", background: "linear-gradient(190deg, rgba(33, 150, 243, 0.4) 100%, rgba(33, 150, 243, 0) 30%)" }}>
